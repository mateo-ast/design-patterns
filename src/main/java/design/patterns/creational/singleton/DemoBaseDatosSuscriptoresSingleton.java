...
/**
 * Demostración que muestra el uso del singleton BaseDatosSuscriptores.
 *
 * El ejemplo realiza cuatro llamadas a suscribir, donde el mismo correo
 * se intenta registrar dos veces para demostrar que solo se crea una vez.
 */
public class DemoBaseDatosSuscriptoresSingleton implements DesignPattern {
